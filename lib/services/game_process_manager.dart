...
class GameProcessManager {
  ...
  Future<bool> launchGame(String gameId, String executablePath) async {
    try {
      ...
      LoggingService.instance.logError('启动游戏失败: $e');
      return false;
    }
  }
  ...
  Future<void> _startMonitoring() async {
    ...
    try {
      ...
      if (!success) {
        LoggingService.instance.logError('启动 ETW 进程监控失败，可能需要管理员权限');
        return;
      }
      ...
      LoggingService.instance.logError('启动进程监控失败: $e');
    }
  }
  ...
  Future<void> _startFileMonitoring() async {
    ...
    try {
      ...
      if (!success) {
        LoggingService.instance.logError('启动 ETW 文件监控失败，可能需要管理员权限');
        return;
      }
      ...
      LoggingService.instance.logError('启动文件监控失败: $e');
    }
  }
  ...
  Future<void> _stopMonitoring() async {
    ...
    try {
      ...
      LoggingService.instance.logError('停止进程监控失败', e);
    }
  }
  ...
  Future<void> _stopFileMonitoring() async {
    ...
    try {
      ...
      LoggingService.instance.logError('停止文件监控失败: $e');
    }
  }
  ...
  Future<bool> killGame(String gameId) async {
    ...
    try {
      ...
      LoggingService.instance.logError('终止游戏进程失败: $e');
      return false;
    }
  }
  ...
  Future<void> _onGameEnded(String gameId, GameProcessInfo gameInfo) async {
    try {
      ...
      LoggingService.instance.logError('处理游戏结束事件失败: $e');
      // 即使统计失败，也要继续处理自动备份
      _handleAutoBackup(gameId);
    }
  }
  ...
  Future<void> _handleAutoBackup(String gameId) async {
    try {
      ...
      LoggingService.instance.logError('处理自动备份失败: $e');
      if (_autoBackupCallback != null) {
  ...
  Future<void> _recordPlaySession(
    ...
    try {
      ...
      LoggingService.instance.logError('记录游戏会话失败: $e');
    }
  }
